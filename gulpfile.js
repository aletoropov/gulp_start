...
const gulpIf = require('gulp-if');                              // Для создания условий в gulp-тасках
...
const reload = browserSync.reload;                              // Перезагрузка live - сервера при разработке
